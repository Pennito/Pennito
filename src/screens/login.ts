...
export class LoginScreen {
  ...
  private createMobileInputs(): void {
    ...
    (this.usernameInput as any).autocapitalize = 'none'; // iOS: prevent auto-capitalization
    (this.usernameInput as any).autocorrect = 'off'; // iOS: disable autocorrect
    ...
    (this.passwordInput as any).autocapitalize = 'none'; // iOS: prevent auto-capitalization
    (this.passwordInput as any).autocorrect = 'off'; // iOS: disable autocorrect
