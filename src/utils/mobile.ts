...
export class MobileControls {
  ...
  private virtualKeyboard: HTMLDivElement | null = null;
  ...
  public showKeyboard(onSend: (text: string) => void): void {
    if (!this.virtualKeyboard || !this.chatInput) return;
